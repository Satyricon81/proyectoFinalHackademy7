                            ...
                            <div class="row p-md-5">
                                <div class="col-6">
                                    ...
                                    <div class="form-group mb-3 text-bold">
                                        <label for="form-label" class="my-2">Categories</label>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="adBody">Description</label>
                                    ...
                                    @enderror
                                    <div class="mb-3">
                                        <label for="adImages" class="form-label">Images</label>
                                ...
                                <div class="col-6 d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <button type="submit" class="btn botonanuncio mt-5">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
