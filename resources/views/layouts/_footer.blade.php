<footer class="py-5 sticky-bottom">
    <div class="container">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-4 col-md-3 contacto">
            ...
            <div class="col-4 col-md-3 newsletter">
                <form>
                    ...
                    <div class="d-flex justify-content-end w-100 gap-2">
                        ...
                        <button class="btn me-1 fw-bold" type="button" style="background-color:#F0A646">{{ __('ui.footerhead3boton') }}</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="d-flex justify-content-center mt-4 py-4 border-top">
            ...
            <p class="d-flex justify-content-center mt-4">© 2022 Rapido, Co. All Rights Reserved.</p>
        </div>
    </div>
</footer>
